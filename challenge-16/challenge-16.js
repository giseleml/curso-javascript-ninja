(function () {
  ...
  */
  console.log( '\nMeus amigos:' );
  var friends = ['Mindy', 'Danny', 'Morgan', 'Tamra', 'Peter', 'Jeremy'];

  var phrase = friends.reduce(function (acc, currentValue, index) {
  ...
  */
  ...
  var myName = 'Stefanni';
  var newName = [];
  for(var i = 0, len = name.length; i < len; i = i + 2) {
